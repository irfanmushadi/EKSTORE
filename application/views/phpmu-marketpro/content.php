<div id="homepage-1">
    ...
    <div class="ps-top-categories d-block d-sm-none" style='margin-top:20px'>
            ...
            <div class="row" style='margin-right:10px; margin-left:10px;'>
                <?php 
                    ...
                    if ($row['icon_kode']!=''){
                        ...
                        $icon = "<img style='width:40px; height:40px' src='".base_url()."asset/foto_produk/$row[icon_image]'>";
                    }else{
                        $icon = "";
                    }
        ...
        </div><center><a class="ps-toggle--sidebar btn-custom" href="#navigation-mobile"><i class="icon-list4"></i><span> Tampilkan Semua Kategori</span></a></center><br>
                    ...
                    echo "<div class='ps-product'>
                            ...
                            <div class='ps-product__container'><a class='ps-product__vendor' href='".base_url()."u/".user_reseller($row['id_reseller'])."'>".cek_paket_icon($row['id_reseller'])." $row[nama_reseller]</a>
                                ...
                                if (stok($row['id_reseller'],$row['id_produk'])<=0){ 
                                    echo "<a style='margin-top:10px; color:#a7a7a7; background-color:#e2e2e2' class='ps-btn ps-btn--fullwidth add-to-cart-empty'>Tambah Keranjang</a>";
                                }else{
                                    echo "<a style='margin-top:10px' id='$row[id_produk]' class='ps-btn ps-btn--fullwidth add-to-cart'>Tambah Keranjang</a>";
                                }
                                echo "</div>
                            </div>
                        </div>";
