                        ...
                        <div class="ps-product__shopping d-none d-sm-block" style='margin-bottom:0rem; padding-bottom:10px'>
                            ...
                            <?php 
                                if (stok($record['id_reseller'],$record['id_produk'])<=0){ 
                                    echo "<a style='color:#a7a7a7; background-color:#e2e2e2' class='ps-btn ps-btn--black ml-3 add-to-cart-empty'>Tambah Keranjang</a>";
                                }else{
                                    echo "<a style='color:#fff' id='$record[id_produk]' class='ps-btn ps-btn--black ml-3 add-to-cart'>Tambah Keranjang</a>";
                                }
                            ?>
                            <!-- <button type='submit' name='keranjang' class="ps-btn ps-btn--black ml-3" href="#">Tambah Keranjang</button> -->
