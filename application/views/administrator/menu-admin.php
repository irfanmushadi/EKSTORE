        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo base_url().$this->uri->segment(1); ?>/home"><i class="fa fa-dashboard"></i> <span>Beranda</span></a></li>
            <li class="treeview">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-book"></i> <span>Laporan Market</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <?php 
